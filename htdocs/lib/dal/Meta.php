...
SQL;
		...
		// execute
		$result =  dal\QueryHandler::executeQuery($query, $con);

		return dal\QueryHandler::getColumn($result, 'Tables_in_culturp7_ktc');
	}
...
SQL;
		dal\QueryHandler::executeQuery($query, $con);
...
SQL;
		...
		return dal\QueryHandler::executeQuery($query, $con);
	}
}

<ul id="admin_press_tabs" class="nav nav-pills">
    ...
    <li><a href="#press_entry_admin" data-toggle="tab">Entry Admin</a></li>
</ul>
<div id="admin_press_tabs_content" class="tab-content">
    <div class="tab-pane fade active in" id="new_press_entry">
        <?php
            include 'admin_press_tab_new_press_tab_include.php';
        ?>
    </div>
    <div class="tab-pane fade" id="press_entry_admin">
        <?php
